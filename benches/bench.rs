...
fn bench_rustbolt_sources(criterion: &mut Criterion) {
  let mut group = criterion.benchmark_group("rustbolt_sources");
...
criterion_group!(rustbolt_sources, bench_rustbolt_sources);
criterion_main!(rustbolt_sources);
